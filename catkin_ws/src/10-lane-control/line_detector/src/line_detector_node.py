...
from duckietown_utils import rectify,load_camera_intrinsics
...
class LineDetectorNode(object):
    def __init__(self):
        ...
        # applying intrinsic paramters(haven't seen they are applied)
        self.cam_intrinsic = load_camera_intrinsics('zmaj')
...
#             self.detector_config = c
    ...
    def processImage_(self, image_msg):
        ...
        image_cv = rectify(image_cv,self.cam_intrinsic)
